<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\WWW\public/../application/admin\view\mrecruit\recruit.html";i:1501385120;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form class="am-form tpl-form-line-form" action="<?php echo url('Mrecruit/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" id="mproduct" value="招聘模块展示"  name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
