<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\WWW\public/../application/admin\view\hcity\physical_store.html";i:1501418016;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
	...
	<link href="/static/admin/css/physical_store.css" rel="stylesheet">
  ...
  <body>
   ...
   <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		 <form class="am-form tpl-form-line-form" action="<?php echo url('hcity/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="实体店" name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
        ...
        </div><img src="/uploads/<?php echo $list['icon']; ?>" width="100" height="160"></a>
                        ...
                        <div class="bottom">
							<?php foreach($data as $vo): ?> 
                                <button type="button" class="btn btn-primary module" 
                                    data-toggle="button"> <?php echo $vo['city_name']; ?>
                                </button>
							<?php endforeach; ?>
                    ...
                    <li class="page_content">
                        <div>
                            <div>
                                <img src="/static/admin/img/store_01.png">
                                <span>地址</span>
                            </div>
                        ...
                        <div>
                            <div>
                               <img src="/static/admin/img/store_02.png">
                                <span>联系电话</span>
                            </div>
                        ...
                        <div>
                            <div>
                                <img src="/static/admin/img/store_03.png">
                                <span>营业时间</span>
                            </div>
	...
	<div class="box">
        ...
        <div id="dialog" class="animated">
            ...
            <form action="" method="post" id="editForm">
                <ul class="editInfo">
                    <li><label style="color:#1e1d1d;"><font color="#ff0000">* </font>地址：<input type="text" name="nick" required value="" class="ipt" /></label></li>
	...
	$(function(){
		...
		$("#set_add").click(function(){
			...
			$.ajax({
					  method: "POST",
					  url: "/index.php/admin/hcity/docity",
					  data: { name: s }
					}).done(function( msg ) {
     ...
     $(".p_content").click(function(){
        ...
        $(".page_content").css("display","block");
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/hcity/upload',
            // 选择文件的按钮。可选。
		...
		$(function(){
			$(".module").click(function(){
				...
				$(this).click(function(){
					$.ajax({
					  method: "POST",
					  url: "/index.php/admin/hcity/doadd",
					  data: { name: name }
					}).done(function( msg ) {
					 // alert( "Data Saved: " + msg );
					});
