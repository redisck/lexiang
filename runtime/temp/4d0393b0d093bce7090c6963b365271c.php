<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\WWW\public/../application/admin\view\guide\list.html";i:1501161708;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501237279;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
									...
									<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            ...
                                            <td><?php echo $vo['guide']; ?></td>
                                            <td class="am-hide-sm-only"><img src="/uploads/<?php echo $vo['img']; ?>" alt="" width="60px" height="30px"></td>
                                            <td class="am-hide-sm-only"></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> <a href="<?php echo \think\Request::instance()->server('script_name'); ?>/admin/guide/edit/id=<?php echo $vo['id']; ?>"> 编辑</a></button>
                                                        <!-- <button class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span class="am-icon-copy"></span> 复制</button> -->
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> <a href="<?php echo \think\Request::instance()->server('script_name'); ?>/admin/guide/delete/id=<?php echo $vo['id']; ?>">删除</a></button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
