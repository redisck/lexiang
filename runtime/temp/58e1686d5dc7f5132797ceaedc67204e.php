<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\WWW\public/../application/admin\view\mcompany\edit.html";i:1501384199;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501237279;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form class="am-form tpl-form-line-form" action="<?php echo url('mcompany/doedit'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="公司简介" name="module"><!-- <input type="hidden" value="<?php echo $data['id']; ?>" name="id"> --> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
							 ...
							 <input type="hidden" name="vice_img" value="<?php echo $data['vice_img']; ?>"> 
        </div><img src="/uploads/<?php echo $data['vice_img']; ?>" width="100" height="160"></a>					
         			...
         			<li class="page_content">
                        ...
                        <div class="editor">
                           <!-- 编辑器 -->
						  <script id="editor" type="text/plain" style="width:1024px;height:500px;" name="myContent"><?php echo $data['link_name']; ?></script>
                        </div>
     ...
     $(".p_content").click(function(){
		...
		<script type="text/javascript">
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/mcompany/upload',
            // 选择文件的按钮。可选。
