<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\WWW\public/../application/admin\view\friend\add.html";i:1501418152;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         	<div class="nav_html">
		 <form class="am-form tpl-form-line-form" action="<?php echo url('friend/doadd'); ?>" enctype="multipart/form-data" method="post">
         		<ul>
         			<li>
         				<div class="nav_top">
         					<div class="left">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" name="module" value="友情链接"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
         				</div>
         			</li>
	...
	<script type="text/javascript">
		...
		$("#set_add").click(function(){
			...
			$.ajax({
					  method: "POST",
					  url: "/index.php/admin/friend/dolink",
					  data: { name: s }
					}).done(function( msg ) {
