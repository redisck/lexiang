<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\WWW\public/../application/admin\view\mproduct\product.html";i:1501463283;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form class="am-form tpl-form-line-form" action="<?php echo url('mproduct/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" id="mproduct" value="产品模块展示"  name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
        ...
        </div><img src="/uploads/<?php echo $data['img']; ?>" width="246" height="117"></a>
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <a><div id="fileList2" class="uploader-list"> <input type="hidden" name="vice_img" value="<?php echo $data['vice_img']; ?>"> 
        </div><img src="/uploads/<?php echo $data['vice_img']; ?>" width="246" height="117"></a>
         			...
         			<li class="page_header">
                        ...
                        <hr>
         				<div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="content" value="<?php echo $data['link_name']; ?>"> <span>*此内容最多100字</span>           
                            </div>
         				</div>
     ...
     $(".p_content").click(function(){
		...
		<script type="text/javascript">
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/mproduct/upload',
            // 选择文件的按钮。可选。
