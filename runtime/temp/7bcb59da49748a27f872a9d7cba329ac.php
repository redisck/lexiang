<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"D:\WWW\public/../application/admin\view\show\edit.html";i:1501410399;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
         		...
         		<ul>
         			...
         			<li class="page_header">
         				...
         				<div class="upload_bottom">
         					...
         					<div>
								 ...
								 <input type="hidden" name="icon" value="<?php echo $list['image']; ?>"> 
        </div><img src="/uploads/<?php echo $list['image']; ?>" width="160" height="30"></a>
         			...
         			<li class="page_header">
         				...
         				<div class="upload_bottom">
         					...
         					<div>
								 ...
								 <input type="hidden" name="image" value="<?php echo $list['vice_img']; ?>"> 
         			...
         			<li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="content" value="<?php echo $list['content']; ?>"> <span>*此内容最多10字</span>           
                            </div>
							<div>
                                <p>关键字</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="key" value="<?php echo $list['key']; ?>"> <span>*此内容最多10字</span>           
                            </div>
                        </div>
                    ...
                    <li class="page_content">
                        <div class="upload_bottom">
                            <div>
                                ...
                                <span>标题</span>  
                                <br>
                                <input type="text" class="title" placeholder="请输入标题内容" name="new_title" value="<?php echo $list['title']; ?>"> <span>*此内容最多20字</span>         
                            </div>
                            <div>
                                <img src="/static/admin/img/company_02.png" width="20">
                                <span>副标题</span>  
