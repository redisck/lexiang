<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\WWW\public/../application/admin\view\index\index.html";i:1501325486;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         	<div class="nav_html">
		 <form class="am-form tpl-form-line-form" action="<?php echo url('index/vv'); ?>" enctype="multipart/form-data" method="post">
         		<ul>
         			<li>
         				<div class="nav_top">
         					<div class="left">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" name="module" value="菜单功能"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
         				</div>
         			</li>
         			<li>
         				...
         				<div class="bottom">
         						<button type="button" class="btn btn-primary module all" 
								   	data-toggle="button"> 公司模块
								</button>
								<button type="button" class="btn btn-primary module all" 
								   	data-toggle="button"> 产品模块
								</button>
								<button type="button" class="btn btn-primary module all" 
								   	data-toggle="button"> 招聘模块
								</button>
         				</div>
         			</li>
         			<li>
         				...
         				<div class="upload_bottom">
         						...
         						<input type="text" >
								   <!--用来存放item-->
							     <button type="button" class="btn btn-default" data-upd="fileList2" id="filePicker">上传文件</button>
         					</div>
         					<div>
         			...
         			<!-- <li>
						...
						<?php endforeach; ?>
								...
								<button type="button" id="jia" class="btn btn-primary module add_to" 
								   	data-toggle="button"> +
								</button>
         				</div>
         			</li>
         			<li>
         				...
         				<div class="upload_bottom">
         					<div>
         						<input type="text">
							     <button type="button" class="btn btn-default" data-upd="fileList" id="filePicker2">上传文件</button>
         					</div>
	...
	<div class="box">
        ...
        <div id="dialog" class="animated">
            ...
            <form action="" method="post" id="editForm">
                <ul class="editInfo">
                    <li><label style="color:#1e1d1d;"><font color="#ff0000">* </font>链接：<input type="text" name="nick" required value="" class="ipt" /></label></li>
	...
	<script type="text/javascript">
		...
		$("#set_add").click(function(){
			...
			$.ajax({
					  method: "POST",
					  url: "/index.php/admin/index/dolink",
					  data: { name: s }
					}).done(function( msg ) {
...
<script type="text/javascript">
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/upload/upload',
            // 选择文件的按钮。可选。
