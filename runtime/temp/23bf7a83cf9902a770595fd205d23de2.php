<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\WWW\public/../application/admin\view\online\edit.html";i:1501402416;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501393950;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
		...
		<form class="am-form tpl-form-line-form" action="<?php echo url('online/doedit'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
						...
						<div id="dls4"></div>
         				...
         				<div class="upload_bottom">
         					...
         					<div>
								 ...
								 <input type="hidden" name="image" value="<?php echo $list['img']; ?>"> 
        </div><img src="/uploads/<?php echo $list['img']; ?>" width="100" height="160"></a>
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <a><div id="fileList2" class="uploader-list">
								 <input type="hidden" name="vice_img" value="<?php echo $list['img2']; ?>"> 
        </div><img src="/uploads/<?php echo $list['img2']; ?>" width="100" height="160"></a>
         			...
         			<li class="page_header">
                        ...
                        <hr>
         				<div class="upload_bottom">
         					<div>
                                <p>标题</p>  
                                <input type="text" class="title" placeholder="请输入标题内容" name="title" value="<?php echo $list['title']; ?>"> <span>*此内容最多20字</span>         
                            </div>
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="vice_heading" value="<?php echo $list['vice_heading']; ?>"> <span>*此内容最多10字</span>           
                            </div>
							 <div>
                                <p>关键字</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="key" value="<?php echo $list['key']; ?>"> <span>*此内容最多100字</span>           
                            </div>
         				</div>
         			...
         			<li class="page_content">
						...
						<?php foreach($store as $vo): ?> 
                                <button type="button" class="btn btn-primary module" 
                                    data-toggle="button"><?php echo $vo['store_name']; ?>
                                </button>
						<?php endforeach; ?>
                               <!--  <button type="button" class="btn btn-primary module" 
                     ...
                     <li class="page_content">
                        ...
                        <div class="upload_bottom">
                            <div>
                                <input class="url" type="text" name="store" />
                            </div>
                        </div>
                    </li>
                     <li class="page_content">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <a><div id="fileList4" class="uploader-list">
								 <input type="hidden" name="icon" value="<?php echo $head['icon']; ?>"> 
        </div><img src="/uploads/<?php echo $head['icon']; ?>" width="100" height="160"></a>
                    ...
                    <li class="page_content">
                       <div class="upload_top">
                        ...
                        <div class="upload_bottom">
                            <div>
                                <input class="url" type="text" name="url" value="<?php echo $list['url']; ?>" />
                            </div>
    ...
    <div class="box">
        ...
        <div id="dialog" class="animated">
            ...
            <form action="" method="post" id="editForm">
                <ul class="editInfo">
                    <li><label style="color:#1e1d1d;"><font color="#ff0000">* </font>店铺地址：<input type="text" name="nick" required value="" class="ipt" /></label></li>
                    <li><label style="color:#1e1d1d;"><font color="#ff0000">* </font>链接：<input type="text" name="" required value="" class="ipt" /></label></li>
