<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\WWW\public/../application/admin\view\add\add_module.html";i:1501405423;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form class="am-form tpl-form-line-form" action="<?php echo url('add/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入副标题" name="vice_heading"> <span>*此副标题最多100字</span>           
                            </div>
                        </div>
