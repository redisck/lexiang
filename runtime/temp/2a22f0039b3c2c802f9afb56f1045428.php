<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"D:\WWW\public/../application/admin\view\add\edit.html";i:1501405738;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form class="am-form tpl-form-line-form" action="<?php echo url('add/doedit'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="新增模块" name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
		...
		<input type="hidden" name="vice_img" value="<?php echo $data['vice_img']; ?>"> 
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入副标题" name="vice_heading" value="<?php echo $data['vice_heading']; ?>"> <span>*此副标题最多100字</span>           
                            </div>
                        </div>
    ...
    $(function(){
		$(".button_saved").css("display","none");
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/add/upload',
            // 选择文件的按钮。可选。
