<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\WWW\public/../application/admin\view\carousel\edit.html";i:1501324834;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
	...
	<link href="/static/admin/css/show.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container-fluid">
     ...
     <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		 <form class="am-form tpl-form-line-form" action="<?php echo url('carousel/doedit'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="基本展示" name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         			...
         			<li>
         				...
         				<div class="upload_bottom">
         					...
         					<div>
								...
								<input type="hidden" name="icon" value="<?php echo $list['nav_img']; ?>"> 
         			...
         			<li>
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
								...
								<input type="hidden" name="image" value="<?php echo $list['nav_img']; ?>"> 
        </div><img src="/uploads/<?php echo $list['nav_img']; ?>" width="100" height="160"></a>
                                <span>预览图  100*150像素</span>
                            </div>
                            <div>
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <a><div id="fileList3" class="uploader-list">
								 <input type="hidden" name="img" value="<?php echo $list['vice_img']; ?>"> 
        </div><img src="/uploads/<?php echo $list['vice_img']; ?>" width="100" height="160"></a>
                                <span>预览图  100*150像素</span>
                            </div>
                            <div>
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="vice_heading" value="<?php echo $list['vice_heading']; ?>"> <span>*此内容最多20字</span>           
                            </div>
                        </div>
	...
	<script type="text/javascript">
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/carousel/upload',
            // 选择文件的按钮。可选。
