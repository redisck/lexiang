<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\WWW\public/../application/admin\view\activity\edit.html";i:1501398143;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
      ...
      <div class="row">
	   <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 <form class="am-form tpl-form-line-form" action="<?php echo url('activity/doedit'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
        ...
        </div><img src="/uploads/<?php echo $data['img']; ?>" width="100" height="160"></a>
        ...
        </div><img src="/uploads/<?php echo $data['img2']; ?>" width="100" height="160"></a>
         			...
         			<li class="page_header">
                        ...
                        <hr>
         				<div class="upload_bottom">
         					<div>
                                <p>标题</p>  
                                <input type="text" class="title" placeholder="请输入标题内容" name="title" value="<?php echo $data['news']; ?>"> <span>*此内容最多20字</span>         
                            </div>
                            <div>
                                <p>副标题</p>   
         		...
         		<!-- 	<li class="page_content">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <a><div id="fileList3" class="uploader-list">
								 <input type="hidden" name="icon" value="<?php echo $summary['icon']; ?>"> 
        </div><img src="/uploads/<?php echo $data['img']; ?>" width="100" height="160"></a>
                                <span>预览图  20*160像素</span>
                            </div>
                            <div>
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <a><div id="fileList4" class="uploader-list">
									 <input type="hidden" name="image" value="<?php echo $summary['image']; ?>"> 
        </div><img src="/uploads/<?php echo $data['img']; ?>" width="100" height="160"></a>
                                <span>预览图  100*160像素</span>
                            </div>
                            <div>
                    ...
                    <li class="page_content add_content">
                        ...
                        <div class="upload_bottom">
                            <div>
                                <p>标题</p>  
                                <input type="text" class="title" placeholder="请输入标题内容" name="new_title" value="<?php echo $data['news']; ?>"> <span>*此内容最多20字</span>         
                            </div>
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="new_content" value="<?php echo $data['content']; ?>"> <span>*此内容最多10字</span>           
                            </div>
