<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\WWW\public/../application/admin\view\activityhead\edit.html";i:1501393316;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501392142;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
	...
	<link href="/static/admin/css/activity.css" rel="stylesheet">
  ...
  <body>
      ...
      <div class="row">
	   <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="<?php echo url('activity/index'); ?>">活动</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 <form class="am-form tpl-form-line-form" action="<?php echo url('activityhead/doedit'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="活动" name="module"> </li>
								  <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
                            <button type="button" class="btn btn-primary module p_header" 
                                    data-toggle="button"> 活动头部
                                </button>
        ...
        </div><img src="/uploads/<?php echo $data['icon']; ?>" width="100" height="160"></a>
        ...
        </div><img src="/uploads/<?php echo $data['image']; ?>" width="100" height="160"></a>
         			...
         			<li class="page_header">
                        ...
                        <hr>
         				<div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="vice_heading" value="<?php echo $data['title']; ?>"> <span>*此内容最多100字</span>           
                            </div>
         				</div>
                    ...
                    <li class="page_content add_content">
                        <div class="upload_top">
                            <img src="/static/admin/img/nav_12.png" width="20">
                            <span>小图标上传</span>
                        </div>
                        <div class="upload_bottom">
                            <div>
                                <input type="text">
                                 <button type="button" class="btn btn-default" id="filePicker3">上传文件</button>
                            </div>
                            <div>
                                <a><div id="fileList3" class="uploader-list">
								 <input type="hidden" name="icon" value="<?php echo $data['icon']; ?>"> 
        </div><img src="/uploads/<?php echo $data['icon']; ?>" width="100" height="160"></a>
                                <span>预览图  20*160像素</span>
                            </div>
                    ...
                    <li class="page_content add_content">
                        ...
                        <div class="upload_bottom">
                            <div>
                                <p>标题</p>  
                                <input type="text" class="title" placeholder="请输入标题内容" name="new_title" value="<?php echo $data['title']; ?>"> <span>*此内容最多20字</span>         
                            </div>
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="new_content" value=""> <span>*此内容最多10字</span>           
                            </div>
                        </div>
                ...
                <div class="add_activity">
                            <img src="/static/admin/img/activity_01.png">
                            <p>增加新活动模块</p>
                </div>
         	</div>
			</form>
    ...
    $(function() {  
     ...
     $(".add_activity img").click(function(){
        $(".add_content").toggle();
        $(".add_activity").toggle();
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/Activity/upload',
            // 选择文件的按钮。可选。
      ...
      //上传完成事件监听
		...
		uploader.on('uploadSuccess', function (file, response) {
			...
			var $list3=$("#fileList3");   //这几个初始化全局的百度文档上没说明，好蛋疼
           var thumbnailWidth = 100;   //缩略图高度和宽度 （单位是像素），当宽高度是0~1的时候，是按照百分比计算，具体可以看api文档  
           var thumbnailHeight = 100;  
           var uploader = WebUploader.create({
            // 选完文件后，是否自动上传。
      ...
      //上传完成事件监听
        uploader.on( 'fileQueued', function(file) {
			...
			uploader.on('uploadSuccess', function (file, response) {
            $("#dls3").append('<input name="package3" type="hidden" value="' + response._raw + '">')
		});
     })
    })
