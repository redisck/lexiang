<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\WWW\public/../application/admin\view\activityhead\activity.html";i:1501393619;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
      ...
      <div class="row">
	   <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 <form class="am-form tpl-form-line-form" action="<?php echo url('activityhead/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         		...
         		<!-- 	<li class="page_content">
                    ...
                    <li class="page_content add_content">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="new_content"> <span>*此内容最多100字</span>           
                            </div>
                        </div>
