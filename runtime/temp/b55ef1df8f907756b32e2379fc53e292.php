<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\WWW\public/../application/admin\view\mcompany\company.html";i:1501383291;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<form class="am-form tpl-form-line-form" action="<?php echo url('mcompany/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="公司简介" name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
                    ...
                    <li class="page_header">
                        ...
                        <div class="upload_bottom">
                            ...
                            <div>
								...
								<!-- <input type="hidden" name="nav_img" value="<?php echo $data['nav_img']; ?>"> -->
         			...
         			<li class="page_header">
                        ...
                        <hr>
         				<div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="vice_heading" value="<?php echo $data['vice_heading']; ?>"> <span>*此内容最多100字</span>           
                            </div>
         				</div>
