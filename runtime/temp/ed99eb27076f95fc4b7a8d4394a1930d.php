<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\WWW\public/../application/admin\view\goods\hot_products.html";i:1501045141;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501393950;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
     ...
     <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 <form class="am-form tpl-form-line-form" action="<?php echo url('goods/add'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="" name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                             <div>
                    ...
                    <li class="page_content">
                        ...
                        <div class="upload_bottom">
                            <div>
                                <input class="url" type="url" value="URL:" name="key" />
                            </div>
                            <div class="button">
        ...
        $(".page_header").css("display","block");
		 var $list2=$("#fileList2");   //这几个初始化全局的百度文档上没说明，好蛋疼
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/goods/upload',
            // 选择文件的按钮。可选。
