<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\WWW\public/../application/admin\view\background\edit.html";i:1501197042;s:56:"D:\WWW\public/../application/admin\view\public\head.html";i:1501312762;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501237279;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		 <form class="am-form tpl-form-line-form" action="<?php echo url('background/mm'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="upload_bottom">
         					...
         					<div>
         						<a><div id="fileList" class="uploader-list">
									<input type="hidden" name="icon" value="<?php echo $data['bg_img']; ?>"> 
        </div><img src="/uploads/<?php echo $data['bg_img']; ?>" width="246" height="117"></a>
