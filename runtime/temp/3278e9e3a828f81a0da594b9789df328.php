<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\WWW\public/../application/admin\view\recruit\recruit.html";i:1501418081;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501404083;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
	...
	<link href="/static/admin/css/recruit.css" rel="stylesheet">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 <form class="am-form tpl-form-line-form" action="<?php echo url('recruit/doadd'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         				...
         				<div class="nav_bottom">
         					<ul>
         						<li>+模块名称</li>
         						<li><input type="text" value="职位" name="module"> </li>
         						<li>* 文字内容不超过6个字符</li>
         					</ul>
                            <div>
         			...
         			<li class="page_header">
                        ...
                        <hr>
         				<div class="upload_bottom">
                            ...
                            <div>
                                <p>副标题</p>   
                                <input type="text" class="title" placeholder="请输入标题内容" name="vice_heading"> <span>*此内容最多10字</span>           
                            </div>
         				</div>
         			...
         			<li class="page_content">
						...
						<?php foreach($data as $vo): ?>
                                <button type="button" class="btn btn-primary module" 
                                    data-toggle="button"><?php echo $vo['cate_name']; ?>
                                </button>
						<?php endforeach; ?>
                               <!--  <button type="button" class="btn btn-primary module" 
                                    data-toggle="button">客服专员
                                </button> -->
                    ...
                    <li  class="page_content">
                       <div class="upload_bottom">
                            <div>
                                ...
                                <span>标题</span>  
                                <br>
                                <input type="text" class="title" placeholder="请输入标题内容" name="name"> <span>*此内容最多20字</span>         
                            </div>
                            <div>
                                <img src="/static/admin/img/company_02.png" width="20">
                                <span>副标题</span>  
                                <br>  
                                <input type="text" class="title" placeholder="请输入标题内容" name="content"> <span style="float: right;">*此内容最多100字</span>           
                            </div>
                        </div>
                       <p>编辑位置</p>
                        <div class="editor">
   ...
   <div class="box">
        ...
        <div id="dialog" class="animated">
            ...
            <form action="" method="post" id="editForm">
                <ul class="editInfo">
                    <li><label style="color:#1e1d1d;"><font color="#ff0000">* </font>职位：<input type="text" name="nick" required value="" class="ipt" /></label></li>
    ...
    <script type="text/javascript">
		...
		$("#set_add").click(function(){
			...
			$.ajax({
					  method: "POST",
					  url: "/index.php/admin/recruit/docate",
					  data: { name: s }
					}).done(function( msg ) {
	...
	<script type="text/javascript">
           ...
           swf: '/static/admin/webuploader/uploader.swf', //加载swf文件，路径一定要对
            // 文件接收服务端。
            server: '/index.php/admin/recruit/upload',
            // 选择文件的按钮。可选。
            // 内部根据当前运行是创建，可能是input元素，也可能是flash.
            pick: '#filePicker2',
            // 只允许选择图片文件。
		...
		$(function(){
			$(".module").click(function(){
				...
				$(this).click(function(){
					$.ajax({
					  method: "POST",
					  url: "/index.php/admin/recruit/doadd",
					  data: { name: name }
					}).done(function( msg ) {
					 // alert( "Data Saved: " + msg );
					});
