<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\WWW\public/../application/admin\view\guide\edit.html";i:1501196140;s:56:"D:\WWW\public/../application/admin\view\public\left.html";i:1501237279;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <body>
   ...
   <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			 <form class="am-form tpl-form-line-form" action="<?php echo url('guide/mm'); ?>" enctype="multipart/form-data" method="post">
         	<div class="nav_html">
         		<ul>
         			<li>
         				<div class="nav_top">
         			...
         			<li>
         				...
         				<div class="upload_bottom">
         					...
         					<div>
								...
								<input type="hidden" name="icon" value="<?php echo $data['img']; ?>"> 
